...
replace_brackets = lambda x : x.replace("(","").replace(")","").split(" ")[1:] #람다를 이용해서 괄호 여닫이 다 없애기 split을 해서 리스트를 반환시키기
...
row1 = {"sido":sido, "region":region, "sep1":"민간공고대수","sep2":"법인과기관","value":0}
